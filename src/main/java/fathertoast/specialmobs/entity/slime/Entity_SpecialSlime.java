...
public
class Entity_SpecialSlime extends EntitySlime implements ISpecialMob
{
	@SuppressWarnings( "unused" )
	public static
	BestiaryInfo GET_BESTIARY_INFO( )
	{
		BestiaryInfo info = new BestiaryInfo( 0x7ebf6e );
		return info;
	}
	
	private static final DataParameter< Float > SCALE = EntityDataManager.createKey( Entity_SpecialSlime.class, DataSerializers.FLOAT );
	...
	{
		return SpecialMobsMod.TEXTURE_PATH + "slime/" + type + ".png";
	}
	
	static
	void ADD_BASE_LOOT( LootTableBuilder loot )
	{
		loot.addLootTable( "main", "Base loot", LootTableList.ENTITIES_SLIME );
	}
	...
	public
	Entity_SpecialSlime( World world ) { super( world ); }
	...
	protected
	EntitySlime getSplitSlime( ) { return new Entity_SpecialSlime( world ); }
	...
	@Override
	protected
	ResourceLocation getLootTable( ) { return isSmallSlime( ) ? LootTableList.ENTITIES_SLIME : LootTableList.EMPTY; }
	...
	{
		return Config.get( ).SLIMES.TINY_SLIME_DAMAGE || super.canDamagePlayer( );
	}
