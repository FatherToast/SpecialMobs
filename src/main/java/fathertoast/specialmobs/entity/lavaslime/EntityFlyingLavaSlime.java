...
public
class EntityFlyingLavaSlime extends Entity_SpecialLavaSlime
{
	...
	{
		ADD_BASE_LOOT( loot );
		loot.addCommonDrop( "base", "Feathers", Items.FEATHER );
	}
	
	public
	EntityFlyingLavaSlime( World world )
	{
		super( world );
	...
	@Override
	protected
	EntitySlime getSplitSlime( ) { return new EntityFlyingLavaSlime( world ); }
