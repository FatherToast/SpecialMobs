...
public
class Entity_SpecialEnderman extends EntityEnderman implements ISpecialMob
{
	...
	private static final DataParameter< Float > SCALE = EntityDataManager.createKey( Entity_SpecialEnderman.class, DataSerializers.FLOAT );
	...
	{
		return SpecialMobsMod.TEXTURE_PATH + "enderman/" + type + ".png";
	}
	
	static
	void ADD_BASE_LOOT( LootTableBuilder loot )
	{
		loot.addLootTable( "main", "Base loot", LootTableList.ENTITIES_ENDERMAN );
	}
	...
	public
	Entity_SpecialEnderman( World world )
	{
		super( world );
