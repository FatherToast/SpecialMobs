...
public
class EntityWitchCaveSpider extends Entity_SpecialCaveSpider
{
	...
	public
	EntityWitchCaveSpider( World world ) { super( world ); }
	...
	void onTypeAttack( Entity target )
	{
		if( target instanceof EntityLivingBase ) {
			((EntityLivingBase) target).addPotionEffect( MobHelper.nextWitchSpiderEffect( rand, world, false ) );
