...
public
class EntityMotherSpider extends Entity_SpecialSpider
{
	...
	public
	EntityMotherSpider( World world )
	{
		super( world );
		setSize( 1.8F, 1.2F );
	...
	void applyTypeAttributes( )
	{
		...
		getSpecialData( ).addAttribute( SharedMonsterAttributes.ATTACK_DAMAGE, 3.0 );
