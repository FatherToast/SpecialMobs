...
public
class Entity_SpecialSpider extends EntitySpider implements ISpecialMob
{
	...
	private static final DataParameter< Float > SCALE = EntityDataManager.createKey( Entity_SpecialSpider.class, DataSerializers.FLOAT );
	...
	{
		return SpecialMobsMod.TEXTURE_PATH + "spider/" + type + ".png";
	}
	
	static
	void ADD_BASE_LOOT( LootTableBuilder loot )
	{
		loot.addLootTable( "main", "Base loot", LootTableList.ENTITIES_SPIDER );
	}
	...
	public
	Entity_SpecialSpider( World world ) { super( world ); }
