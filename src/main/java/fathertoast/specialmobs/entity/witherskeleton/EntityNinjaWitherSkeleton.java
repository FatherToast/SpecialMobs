...
public
class EntityNinjaWitherSkeleton extends Entity_SpecialWitherSkeleton implements INinja
{
	...
	private static final DataParameter< Boolean >                 IS_HIDING    = EntityDataManager.createKey( EntityNinjaWitherSkeleton.class, DataSerializers.BOOLEAN );
	private static final DataParameter< Optional< IBlockState > > HIDING_BLOCK = EntityDataManager.createKey( EntityNinjaWitherSkeleton.class, DataSerializers.OPTIONAL_BLOCK_STATE );
	...
	public
	EntityNinjaWitherSkeleton( World world ) { super( world ); }
