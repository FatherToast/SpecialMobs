...
public
class EntityFishingZombie extends Entity_SpecialZombie implements IAngler
{
	...
	private static final DataParameter< Boolean > IS_LINE_OUT = EntityDataManager.createKey( EntityFishingZombie.class, DataSerializers.BOOLEAN );
	...
	public
	EntityFishingZombie( World world )
	{
		super( world );
