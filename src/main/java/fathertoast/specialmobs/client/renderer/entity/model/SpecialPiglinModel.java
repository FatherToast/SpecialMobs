 ...
 * <br><br>
 * Checks if the mob is in the {@link fathertoast.specialmobs.common.core.register.SMTags.EntityTypes#ZOMBIFIED_PIGLINS}
 * tag and animates arms to stand out like a zombie if so.
 */
