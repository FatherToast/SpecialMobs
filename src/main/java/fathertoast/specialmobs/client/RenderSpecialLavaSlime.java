...
class RenderSpecialLavaSlime extends RenderMagmaCube
{
	RenderSpecialLavaSlime( RenderManager renderManager )
	{
		super( renderManager );
		addLayer( new LayerSpecialMobEyes<>( this ) );
		// Model doesn't support size parameter
		//addLayer( new LayerSpecialMobOverlay<>( this, new ModelMagmaCube( 0.25F ) ) );
	}
	
	// Returns the location of an entity's texture. Doesn't seem to be called unless you call Render.bindEntityTexture.
	@Override
	protected
	ResourceLocation getEntityTexture( EntityMagmaCube entity )
	{
	...
	@Override
	protected
	void preRenderCallback( EntityMagmaCube entity, float partialTick )
	{
