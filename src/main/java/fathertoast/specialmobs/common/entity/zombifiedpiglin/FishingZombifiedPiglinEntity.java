...
public class FishingZombifiedPiglinEntity extends _SpecialZombifiedPiglinEntity implements IAngler {
    ...
    public static String[] getTranslations( String langKey ) {
        return References.translations( langKey, "Zombified Fishing Piglin",
                "", "", "", "", "", "" );//TODO
    }
    ...
    @SpecialMob.Factory
    public static EntityType.EntityFactory<FishingZombifiedPiglinEntity> getVariantFactory() { return FishingZombifiedPiglinEntity::new; }
    ...
    public FishingZombifiedPiglinEntity( EntityType<? extends _SpecialZombifiedPiglinEntity> entityType, Level level ) { super( entityType, level ); }
    ...
    private static final EntityDataAccessor<Boolean> IS_LINE_OUT = SynchedEntityData.defineId( FishingZombifiedPiglinEntity.class, EntityDataSerializers.BOOLEAN );
