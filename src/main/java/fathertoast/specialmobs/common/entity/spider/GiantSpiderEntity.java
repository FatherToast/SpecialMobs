...
public class GiantSpiderEntity extends _SpecialSpiderEntity {
    ...
    @SpecialMob.Factory
    public static EntityType.EntityFactory<GiantSpiderEntity> getVariantFactory() { return GiantSpiderEntity::new; }
    
    /** @return This entity's mob species. */
    @SpecialMob.SpeciesSupplier
    @Override
    public MobFamily.Species<? extends GiantSpiderEntity> getSpecies() { return SPECIES; }
    
    
    //--------------- Variant-Specific Implementations ----------------
    
    public GiantSpiderEntity( EntityType<? extends _SpecialSpiderEntity> entityType, Level level ) { super( entityType, level ); }
