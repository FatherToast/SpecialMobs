...
@SpecialMob
public class _SpecialMagmaCubeEntity extends MagmaCube implements ISpecialMob<_SpecialMagmaCubeEntity> {
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return MagmaCube.createAttributes(); // Slimes define their attributes elsewhere based on size
    }
    ...
    public static String[] getTranslations( String langKey ) {
        ...
        return References.translations( langKey, "Magma Cube",
                "Cubo de magma", "Cubo de magma", "Cube de magma",
                "Cubo di magma", "Magmawürfel", "Cube o' Magma" );
    }
    ...
    @SpecialMob.Factory
    public static EntityType.EntityFactory<_SpecialMagmaCubeEntity> getFactory() { return _SpecialMagmaCubeEntity::new; }
    ...
    private static final EntityDataAccessor<Float> SCALE = SynchedEntityData.defineId( _SpecialMagmaCubeEntity.class, EntityDataSerializers.FLOAT );
    
    /** Used to reset slimes' attributes to their freshly spawned state so attribute adjustments may be reapplied on size change. */
    private static ListTag magmaCubeAttributeSnapshot;
    ...
    public _SpecialMagmaCubeEntity( EntityType<? extends _SpecialMagmaCubeEntity> entityType, Level level ) {
