...
@SpecialMob
public class _SpecialZombieEntity extends Zombie implements RangedAttackMob, ISpecialMob<_SpecialZombieEntity> {
    ...
    public static AttributeSupplier.Builder createAttributes() { return Zombie.createAttributes(); }
    ...
    protected void registerGoals() {
        ...
        AIHelper.replaceHurtByTarget( this, new SpecialHurtByTargetGoal( this, Zombie.class )
    ...
    protected EntityType<? extends Zombie> getVariantConversionType() { return _SpecialDrownedEntity.SPECIES.entityType.get(); }
    ...
    private static final EntityDataAccessor<Float> SCALE = SynchedEntityData.defineId( _SpecialZombieEntity.class, EntityDataSerializers.FLOAT );
    
    /** This entity's attack AI. */
    private Goal currentAttackAI;
    
    public _SpecialZombieEntity( EntityType<? extends _SpecialZombieEntity> entityType, Level level ) {
