...
public class SniperSkeletonEntity extends _SpecialSkeletonEntity {
    ...
    @SpecialMob.Factory
    public static EntityType.EntityFactory<SniperSkeletonEntity> getVariantFactory() { return SniperSkeletonEntity::new; }
    ...
    public SniperSkeletonEntity( EntityType<? extends _SpecialSkeletonEntity> entityType, Level level ) { super( entityType, level ); }
