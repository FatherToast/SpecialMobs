...
public class JumpingCreeperEntity extends _SpecialCreeperEntity {
    ...
    @SpecialMob.Factory
    public static EntityType.EntityFactory<JumpingCreeperEntity> getVariantFactory() { return JumpingCreeperEntity::new; }
    ...
    public JumpingCreeperEntity( EntityType<? extends _SpecialCreeperEntity> entityType, Level level ) { super( entityType, level ); }
