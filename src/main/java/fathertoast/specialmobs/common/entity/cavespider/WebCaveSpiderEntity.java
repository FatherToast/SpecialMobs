...
public class WebCaveSpiderEntity extends _SpecialCaveSpiderEntity {
    ...
    public static SpeciesConfig createConfig( ConfigManager manager, MobFamily.Species<?> species ) {
        return new WebSpiderSpeciesConfig( manager, species, 0.01, 2, 6 );
    }
    ...
    @SpecialMob.Factory
    public static EntityType.EntityFactory<WebCaveSpiderEntity> getVariantFactory() { return WebCaveSpiderEntity::new; }
    ...
    public WebCaveSpiderEntity( EntityType<? extends _SpecialCaveSpiderEntity> entityType, Level level ) {
