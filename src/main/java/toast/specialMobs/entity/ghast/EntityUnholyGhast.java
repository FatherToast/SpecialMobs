...
public class EntityUnholyGhast extends EntityMeleeGhast {
    ...
    public EntityUnholyGhast( World world ) {
        super( world );
        setSize( 2.0F, 2.0F );
        getSpecialData().setTextures( EntityUnholyGhast.TEXTURES );
            ...
            if( attacker instanceof EntityLivingBase ) {
                ...
                if( heldItem != null ) {
                    ...
                    if( heldItem.hasTagCompound() ) {
                        ...
                        return tinkerTag.hasKey( "ModSmite" ) && tinkerTag.getIntArray( "ModSmite" )[0] > 0;
                    }
                }
            }
        }
    ...
    protected void dropRareDrop( int superRare ) {
        ...
        drop.addEnchantment( Enchantment.fireAspect, rand.nextInt( 2 ) + 1 );
