...
public class Entity_SpecialSpider extends EntitySpider implements ISpecialMob, IRangedAttackMob
{
    ...
    protected void entityInit() {
        this.specialData = new SpecialMobData(this, Entity_SpecialSpider.TEXTURES);
        super.entityInit();
        if (this.rand.nextDouble() < Entity_SpecialSpider.SPIT_CHANCE) {
    ...
    public void adjustEntityAttributes() {
        if (this.rand.nextDouble() < Entity_SpecialSpider.HOSTILE_CHANCE) {
            this.isHostile = true;
        }
    ...
    public IEntityLivingData onSpawnWithEgg(IEntityLivingData data) {
        return this.getSpecialData().onSpawnWithEgg(data, new EntitySpider(this.worldObj));
    }
